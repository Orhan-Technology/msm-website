...
export default async function ProductPage({
  ...
  const { slug } = await params;
  const [products, t, tc] = await Promise.all([
    getProducts(),
      ...
      <main>
          ...
          <div className="container-x grid gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                >
                  {tc("viewSpecifications")}
                </a>
              </div>
              <p className="mt-4 text-xs text-mist">{t("quoteNote")}</p>
            </div>
          </div>
        </section>
          ...
          <div className="container-x grid gap-12 lg:grid-cols-3">
            ...
            <aside>
              <div className="rounded-card bg-charcoal p-7 text-sand">
                <h3 className="text-sand">{t("customOrderTitle")}</h3>
                <p className="mt-2 text-sm text-mist">{t("customOrderBody")}</p>
                <Link
                  href="/contact"
        ...
        <section className="section bg-white text-ink">
          <div className="container-x">
            <h2 className="mb-10">{t("relatedProducts")}</h2>
